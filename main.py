...
from src.text_transforms import CAsT_Index_store, Base_Info_Transform
...
if args.from_checkpoint != '':
    ...
    re_writer.load(args.from_checkpoint)
...
# Evaluate model
eval_experiment = TREC_Eval_Command_Experiment(save_run_path=f"runs/{model_name}.run", save_eval_path=f"evals/{model_name}.eval", key_fields={'source_field':'search_results'})
